...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-border bg-card">
      ...
      {/* Content area with frosted glass backdrop in sakura theme */}
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className={theme === "sakura" ? "rounded-xl border border-white/30 bg-white/40 px-6 py-8 backdrop-blur-md sm:px-8 sm:py-10" : ""}>
          {/* Rule */}
